...
template <class UBO, class Vertex>
void GP2_PBRMetalnessPipeline<UBO, Vertex>::AddMesh(std::unique_ptr<GP2_Mesh<Vertex>> mesh)
{
	m_Meshes.push_back(std::move(mesh));
}

template<class UBO, class Vertex>
inline void GP2_PBRMetalnessPipeline<UBO, Vertex>::SetTextureMaps(const VulkanContext& context, const std::string& diffuse, const std::string& normal,
	const std::string& metalness, const std::string& roughness, QueueFamilyIndices queueFamInd, VkQueue graphicsQueue)
{
...
template <class UBO, class Vertex>
VkPushConstantRange GP2_PBRMetalnessPipeline<UBO, Vertex>::CreatePushConstantRange()
{
...
template <class UBO, class Vertex>
void GP2_PBRMetalnessPipeline<UBO, Vertex>::CreateGraphicsPipeline()
{
...
template <class UBO, class Vertex>
void GP2_PBRMetalnessPipeline<UBO, Vertex>::DrawScene(const GP2_CommandBuffer& cmdBuffer)
{
	for (auto& mesh : m_Meshes)
	{
...
template <class UBO, class Vertex>
void GP2_PBRMetalnessPipeline<UBO, Vertex>::Record(const GP2_CommandBuffer& cmdBuffer, VkExtent2D extent, int imageIndex)
{
...
template <class UBO, class Vertex>
void GP2_PBRMetalnessPipeline<UBO, Vertex>::SetUBO(UBO ubo, size_t uboIndex)
{
