...
private:
	...
	void initVulkan() {
		...
		std::unique_ptr<GP2_Mesh> m_RectMesh = std::make_unique<GP2_Mesh>();
		m_RectMesh->AddVertex({ GP2_Vertex{{-0.5f,-0.5f,0.f}, {1.f,0.f,0.f}, {1.f,0.f}},
			GP2_Vertex{{0.5f,-0.5f,0.f}, {0.f,1.f,0.f}, {0.f,0.f}},
			GP2_Vertex{{0.5f,0.5f,0.f}, {0.f,0.f,1.f}, {0.f,1.f}},
			GP2_Vertex{{-0.5f,0.5f,0.f}, {1.f,1.f,1.f}, {1.f,1.f}}, });
		...
		//m_ParsedMesh->ParseOBJ("D:\\DAE\\sm4\\graphics prog2\\Resources\\vehicle.obj", true);
		...
		m_GP3D.Initialize(VulkanContext{ device, physicalDevice, renderPass, swapChainExtent }, MAX_FRAMES_IN_FLIGHT,
			"D:\\DAE\\sm4\\graphics prog2\\Resources\\vehicle_diffuse.png", findQueueFamilies(physicalDevice), graphicsQueue);
